...
export function ModernPosInterface({
  ...
  // Desktop/Tablet Layout with enhanced responsiveness
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      {/* Main Content - More responsive layout */}
      <div className="flex flex-col lg:flex-row h-[calc(100vh-180px)]">
        ...
        {/* Cart Sidebar - Hidden on mobile, shows as modal */}
        <div className="hidden lg:block w-96 border-l bg-white/50 p-4 space-y-4 overflow-y-auto">
          <PosCartSidebar
            cart={cart}
            onUpdateCart={handleQuantityUpdate}
            onRemoveFromCart={handleRemoveItem}
